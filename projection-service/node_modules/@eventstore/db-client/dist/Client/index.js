...
class Client {
    ...
    constructor({ throwOnAppendFailure = true, keepAliveInterval = 10000, keepAliveTimeout = 10000, defaultDeadline = 10000, connectionName = (0, uuid_1.v4)(), ...connectionSettings }, channelCredentials = { insecure: false }, defaultUserCredentials) {
        ...
        this.resolveUri = async () => {
            if (__classPrivateFieldGet(this, _Client_nextChannelSettings, "f")?.nextEndpoint) {
            ...
            try {
                const { address, port } = await (0, discovery_1.discoverEndpoint)(__classPrivateFieldGet(this, _Client_connectionSettings, "f"), __classPrivateFieldGet(this, _Client_channelCredentials, "f"), __classPrivateFieldGet(this, _Client_nextChannelSettings, "f")?.failedEndpoint);
                return `${address}:${port}`;
            }
            catch (error) {
                __classPrivateFieldGet(this, _Client_grpcClients, "f").clear();
        ...
        if (channelCredentials.certChain || channelCredentials.privateKey) {
            console.warn("The certChain and privateKey options have been deprecated and will be removed in the next major version. Please use userCertFile and userKeyFile instead.");
        }
        ...
        if (__classPrivateFieldGet(this, _Client_insecure, "f")) {
            ...
            __classPrivateFieldSet(this, _Client_channelCredentials, grpc_js_1.credentials.createSsl(channelCredentials.rootCertificate, channelCredentials.userKeyFile ?? channelCredentials.privateKey, channelCredentials.userCertFile ?? channelCredentials.certChain, channelCredentials.verifyOptions), "f");
        }
    }
    /**
